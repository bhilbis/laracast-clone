...
const CategoryCardChannels: React.FC = () => {
  return (
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex space-x-2 items-center">
              ...
              <button className="py-1 px-3 bg-blue-500 rounded hover:bg-blue-700">Channels</button>
            </div>
          </div>
...
export default CategoryCardChannels;
